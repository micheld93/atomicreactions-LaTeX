...
\title{{\color[HTML]{FF0000} APreax Package Introduction}}

\author{B. Michel Döhring}

\date{01/05/2026 (V1.0)}
...
This package is named "\textit{APreax}" which is an appreviation for \underline{A}tomic \underline{P}hysics \underline{Rea}ctions. 
...
This package also provides classical illustration for the atomic model by Niels Bohr \cite{bohr1913}, which shows the shells and electrons in dependence of occupation and chemical element.  

The \textit{APreax}-package can be loaded with the following command: 
...
I will collect all changes in this chapter. 

\subsection{Version 1.0 (01.05.2065)}
...
\begin{itemize}
    \item \url{https://www.ctan.org/pkg/apreax}
    \item \url{https://github.com/micheld93/APreax-LaTeX/}  
\end{itemize}
...
\subsection{Derivation of the Bohr Radius}
...
\subsection{Usage in \textit{APreax}}
 
\textit{APreax} provides the following command:
